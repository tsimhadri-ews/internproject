...
@dsl.pipeline(
    name='Intrusion Detection Unit Testing Pipeline',
    description='A pipeline to test the functions and training and testing results from the intrusion detection pipeline components'
)
