...
kserve_url = f"http://{model['name'][0]}-version{model['version'][0]}-id.kubeflow-user-example-com.svc.cluster.local/v1/models/{model['name'][0]}-version{model['version'][0]}-id:predict"
